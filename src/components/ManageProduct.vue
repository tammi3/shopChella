...
<template>
  <div id="addProduct"
    class="w-full inset-0 absolute z-30 justify-center flex items-start backdrop-blur-lg h-full  py-16">
    <div class="w-full flex justify-center items-center py-4">
      <section class="flex flex-col shadow-lg rounded-lg bg-white w-96 md:w-2/4">
        <div class="flex justify-end p-4 items-center">
          <svg class="cursor-pointer" @click="closeModal()" xmlns="http://www.w3.org/2000/svg" width="20" height="21">
        ...
        <div class="max-w-xl px-4 py-8 mx-auto lg:py-16">
          <form class="addProduct" @submit.prevent="submitForm">
            ...
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-900 " for="image">Upload product
                image <span v-if="action == 'edit'">(optional)</span></label>
              <input
