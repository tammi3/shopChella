  ...
  <div class="sticky top-0 w-full z-50 border-solid border-b">
      ...
      <div class="container mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <div id="nav-links"
          ...
          <routerLink activeClass="border-2 shadow-md shadow-gray-300 border-gray-400 rounded-md  p-2"
            v-for="cat in categories" :to="'/shop/' + cat" class="text-gray-700 font-bold hover:text-gray-900">
            {{ cat }}
          </routerLink>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative lg:pr-4">
            ...
            <div v-if="userInfo != ''" id="profile-menu"
              ...
              <router-link to="/Information/returns_&_exchange"
                activeClass="border-2 shadow-md shadow-gray-300 border-gray-400 rounded-md  p-2 "
                class="text-gray-700 font-bold hover:border-2 hover:rounded-md hover:border-gray-300 p-2">Information
              </router-link>
              <div
    ...
    <div id="cartDisplay"
      ...
      <div class="w-full lg:w-2/4 bg-white z-50 h-screen flex flex-col">
        ...
        <div v-if="cart == ''" class="w-full text-4xl flex flex-col gap-16 p-10 justify-center items-center">
