...
<template>
  <form @submit.prevent="handleSubmit"
    ...
    <div class="w-3/4 flex flex-col gap-3 ">
      ...
      <input v-model="firstName" class="font-normal capitalize focus:outline-none border-b border-gray-600" type="text"
        placeholder="First Name" name="firstName" required />
    </div>

    <div class="w-3/4 flex flex-col gap-3">
      <label for="">Last Name</label>
      <input v-model="lastName" class="font-normal capitalize focus:outline-none border-b border-gray-600" type="text"
    ...
    <div class="w-3/4 flex flex-col gap-3">
      ...
      <select v-on:change="error = ''" id="country" class="border-b pb-1 border-gray-600 w-full focus:outline-none"
    ...
    <div class="w-3/4 flex flex-col gap-3" v-if="selectedCountryCode">

      <label for="city">City:</label>
      <select v-on:change="error = ''" id="city" class="border-b pb-1 border-gray-600 w-full focus:outline-none"
    ...
    <div class="w-3/4 flex flex-col gap-3">
      <div class="flex flex-col">
        <input v-model="street" class="font-normal focus:outline-none border-b border-gray-600" type="text"
    ...
    <div class="w-3/4 flex flex-col gap-3">
      ...
      <input v-model="email" class="font-normal focus:outline-none border-b border-gray-600" type="text"
        placeholder="name@address.com" name="email" required />
    </div>
    <div class="w-3/4 flex flex-col gap-3">
      <label for="">Phone</label>
      <input id="phone" v-model="phone" class="font-normal focus:outline-none border-b border-gray-600"
        v-mask="['####-###-####', '####-###-####']" placeholder="Enter your phone number" name="phone" required />
    </div>
    ...
    <div class="w-3/4 flex flex-col gap-3 tracking-wide">
      ...
      <div class="w-full flex relative">
        <input id="password" class="focus:outline-none w-full font-normal border-b border-gray-600" type="password"
    ...
    <button type="submit"
      class="w-3/4 h-10 uppercase cursor-pointer rounded-xl hover:translate-x-0 hover:-translate-y-2 hover:shadow-lg transform duration-200 ease-in-out border bg-black text-white hover:shadow-black/60 border-black p-4 justify-center items-center flex">
