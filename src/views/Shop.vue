  ...
  <div class="flex flex-col gap-3 py-16">
    <div class="flex justify-center items-center m-4">
      <div class="w-96 h-10 relative bg-gray-400/25 shadow-md rounded-lg">
        <input
          v-model="search"
          class="focus:outline-none absolute bg-transparent uppercase font-Ubuntu top-0 left-0 h-full w-full pr-2 pl-12"
          type="text"
    ...
    <div class="px-10 grid items-end grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      >
        <routerLink :to="'/Product/' + product.id" class="flex flex-col space-y-1">
          ...
          <div
            class="p-2 flex flex-col justify-center items-center font-Ubuntu uppercase"
          >
