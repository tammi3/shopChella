...
<template>
    ...
    <div class="w-3/4 flex flex-col gap-3">
        <div class="flex gap-3">
            <div class="flex  gap-2">
                ...
                <select v-model="country" class="border
            ...
            <div>
                ...
                <select v-model="City" class="border
             border-gray-600 w-40" name="City" id="City">
                    <option v-for="country in countries" value="volvo">{{ country.cities }}</option>
                </select>
            </div>
        </div>
    ...
    <div class="w-3/4 flex flex-col gap-3">
        ...
        <input v-model="email" class="font-normal border-b border-gray-600" type="text" placeholder="name@address.com"
            name="" id="">
    </div>
